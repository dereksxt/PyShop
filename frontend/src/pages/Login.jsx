...
export default function Login() {
  ...
  return (
    // Cambiamos min-h-screen por h-screen y forzamos overflow-hidden para CERO scroll
    <div className="h-screen w-full bg-[#fafbfc] flex flex-col font-sans text-gray-900 overflow-hidden relative">
      
      {/* Header flotante: absolute top-0 left-0 para que no empuje el contenido hacia abajo */}
      ...
      <main className="w-full h-full flex items-center justify-center px-6">
        ...
        <div className="w-full max-w-[1200px] flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
          ...
          {/* LADO IZQUIERDO: Texto impacto alineado a la izquierda */}
          <div className="w-full lg:w-[55%] flex justify-start">
            <div className="max-w-[600px] relative">
              ...
              <h2 className="text-5xl lg:text-[4rem] font-bold text-[#0a1128] leading-[1.05] mb-6 tracking-tight">
                La tienda oficial<br />de Monlau.<br />Todo en un lugar.
              </h2>
              
              <p className="text-[#5b657e] text-xl leading-relaxed mb-14 font-normal">
                Ropa, material escolar y accesorios con el<br />sello oficial Monlau.
              </p>
          ...
          <div className="w-full lg:w-[45%] flex justify-end">
            <div className="w-full max-w-[440px] bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 p-10 sm:p-12">
              <h1 className="text-[1.6rem] font-bold text-[#0a1128] mb-1.5 tracking-tight">Inicia sesión a MonlauShop</h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-4.5">
                ...
                <div className="flex items-center justify-between pt-1 pb-2">
                  <label className="flex items-center gap-2 text-sm text-gray-700 cursor-pointer">
                    <input type="checkbox" className="rounded border-gray-300 text-[#0f172a] focus:ring-[#0f172a] w-3.5 h-3.5 cursor-pointer" />
                    Recuérdame
                  </label>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#0a1128] text-white py-3 rounded-xl font-medium hover:bg-[#111c3d] transition disabled:opacity-50 text-sm"
                >
